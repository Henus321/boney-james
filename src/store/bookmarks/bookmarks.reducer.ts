import { BookmarksAction, BookmarkState, BOOKMARKS_ACTION_TYPES } from './bookmarks.types';
...
export const bookmarksReducer = (state = initialState, action: BookmarksAction) => {
  switch (action.type) {
